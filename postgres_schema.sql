...
-- ----------------------------------------------------------------------------
-- CLEANUP PREVIOUS TABLES (Safe re-run)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- TABLE: properties
-- Stores real estate listings with pricing, specifications, and media
-- ----------------------------------------------------------------------------
...
-- Client bookings for property tours and agent walkthroughs
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- TABLE: inquiries
-- Buyer messages and questions sent to listing agents
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- TABLE: chat_messages
-- Conversation history within each property inquiry
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- TABLE: notifications
-- In-app alert system for appointments, new inquiries, and status changes
-- ----------------------------------------------------------------------------
...
-- Broker / agent licensing and public profile details
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- TABLE: user_accounts
-- User authentication and profiles for Buyers and Licensed Agents
-- ----------------------------------------------------------------------------
...
CREATE INDEX idx_appointments_status ON viewing_appointments(status);
CREATE INDEX idx_inquiries_property ON inquiries(property_id);
CREATE INDEX idx_chat_inquiry ON chat_messages(inquiry_id);
CREATE INDEX idx_notifications_read ON notifications(is_read);

-- ----------------------------------------------------------------------------
-- SEED DATA: PROPERTIES (Matching Estateflow Luxury Listings)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- SEED DATA: USER ACCOUNTS
-- ----------------------------------------------------------------------------
INSERT INTO user_accounts (
    id, name, email, phone, role, license_no, agency, professional_role
) VALUES
(
    'agent_sarah_01',
    'Sarah Jenkins',
...
-- ----------------------------------------------------------------------------
-- SEED DATA: VIEWING APPOINTMENTS
-- ----------------------------------------------------------------------------
...
(
    'notif_002',
    'New Lead: Skyline Penthouse Inquiry',
    'Elena Rostova submitted a VIP tour request for Level 42 Penthouse.',
    '1 hour ago',
    'NEW_INQUIRY',
    FALSE,
    'prop_skyline_02'
...
-- ----------------------------------------------------------------------------
-- VERIFICATION QUERIES (Test directly in pgAdmin Query Tool)
-- ----------------------------------------------------------------------------
-- SELECT * FROM properties;
-- SELECT * FROM viewing_appointments;
